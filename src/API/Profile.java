...
/**
 * Provides a Profile setting that allows users to set their buddies, settings,
 * name and password
 */
...
public class Profile {
    ...
    /**
     * Profile(BuddyList buddyList,String settings, String name) allows users to
    ...
    /**
     * Profile(BuddyList buddyList,String settings, String name, String
     * password, Boolean chkpassword) allows users to create their profile.
     * 
     * @param buddyList
     * @param settings
     * @param name
    ...
    public Profile(BuddyList buddyList, String settings, String name,
            String password, Boolean chkpassword) {
