...
public class ChatbotQADataTypeTest {
    ...
    @Test
    public void testChatbotQADataTypeModelString() throws SQLException,
            ClassNotFoundException {
        // The line down here couldn't be processed, it maybe something with
        // model not able to add the question
    ...
    @Test
    public void testChatbotQADataTypeModelStringString() throws SQLException,
            ClassNotFoundException {
        dt2 =
                new ChatbotQADataType(new Model(), "Are you coming tommorow?",
                        "YES");
        assertSame("Are you coming tommorow?", dt2.getQuestions().get(0));
    ...
    /*
     * @Test public void testRemoveAllQA() {
     * 
     * }
     */
    ...
    public void testToString() {
        ...
        assertEquals("Are you coming tommorow?, Did you finish the paper?", dt1
                .toString());
    }
