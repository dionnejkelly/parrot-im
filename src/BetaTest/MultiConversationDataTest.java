...
public class MultiConversationDataTest {
	...
	public void setUp() throws Exception {
		md1 = new MultiConversationData("Jim",new TwitterAccountData("David","rbc"));
	}
	...
	public void testMultiConversationData() {
		md2 = new MultiConversationData("Mary",new JabberAccountData("big","tyt"));
	...
	public void testEqualsObject() {
		Object expected = new MultiConversationData("Jim",new TwitterAccountData("David","rbc"));
