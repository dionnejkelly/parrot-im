...
/**
 * 
 * GPanel is a special type of JPanel. The only difference between a GPanel and
 * a JPanel is that a GPanel can have a vertical gradient background.
 * 
 * @author Jordan Fox
 * 
 */
public class GPanel extends JPanel {
    ...
    protected void paintComponent(Graphics g) {
        ...
        GradientPaint gpaint = new GradientPaint(0, 0, color1, 0, h, color2);
