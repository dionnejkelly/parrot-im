...
public class ChatlogMessageTempDataTest {
	...
	public void setUp() throws Exception {
		cl1 = new ChatLogMessageTempData("Thur13:00","Ray","Telia","Clean it up!");
		cl2 = new ChatLogMessageTempData("Fri1:17","Vito","Bonasera","So what do you want?");
	}
	...
	public void testChatLogMessageTempData() {
		cl3 = new ChatLogMessageTempData("Sun16:20","Clemenza","Michael","Your father was proud of you");
