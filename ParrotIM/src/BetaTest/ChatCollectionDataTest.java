...
//		ConversationData test = new ConversationData(new GoogleTalkAccountData("rmamnk","123",new GoogleTalkManager(new MainController(new Model()))),new GoogleTalkUserData("rma"));
...
//		ConversationData test = new ConversationData(new GoogleTalkAccountData("rmamnk","Rakan","Home","abc",UserStateType.AWAY,new GoogleTalkManager(new MainController(new Model()))),
...
//		ConversationData expected = new ConversationData(new GoogleTalkAccountData("rmamnk","123",new GoogleTalkManager(new MainController(new Model()))),
