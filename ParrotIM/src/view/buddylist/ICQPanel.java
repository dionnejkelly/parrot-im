 ...
 */
public class ICQPanel extends JPanel implements Observer {
    /*
    ...
    // SELECTION
    // II-Constructors
    public ICQPanel(MainController c, Model model, JFrame buddyWindow) {
        ...
        buddyListPane.addGroup("     ICQ", twitterImage);
