 ...
 */
public class AIMPanel extends JPanel implements Observer {
    /*
    ...
    // SELECTION
    // II-Constructors
    public AIMPanel(MainController c, Model model, JFrame buddyWindow) {
        ...
        buddyListPane.addGroup("     AIM", twitterImage);
