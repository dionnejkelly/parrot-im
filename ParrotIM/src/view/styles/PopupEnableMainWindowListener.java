...
/**
 * This object is a WindowListener for any popup window objects. It controls the
 * boolean variable in Model so the user wouldn't be able to open the same popup
 * multiple times.
 * 
...
public class PopupEnableMainWindowListener implements WindowListener {
    ...
    public PopupEnableMainWindowListener(Model model,
            PopupEnableWindowType popupInt) {
        this.model = model;
    ...
    /**
     * When the chatLogWindow is closed, logWindowOpen will be set to false. It
     * returns nothing.
     */
    ...
    /**
     * When the chatLogWindow is opened, logWindowOpen will be set to true. It
     * returns nothing.
     */
