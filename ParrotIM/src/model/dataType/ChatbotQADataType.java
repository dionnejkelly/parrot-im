...
public class ChatbotQADataType {
    ...
    public ChatbotQADataType(Model model, String question) throws SQLException,
    ...
    public ChatbotQADataType(Model model, String question, String answer)
    ...
    public void addAnswer(String answer) throws ClassNotFoundException,
            SQLException {
    ...
    public void removeAnswer(int index) throws ClassNotFoundException,
            SQLException {
        for (int i = 0; i < questions.size(); i++) {
