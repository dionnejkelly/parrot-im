...
public class StatusCombo extends JComboBox {
    /**
     * chatClient is a MainController object. It helps the user to change their
    ...
    /**
     * StatusCombo constructor. It takes a MainController object as its
     * argument. It also sets up some settings for the object.
     * 
     * @param c
     * @param optionStatus
     */
    ...
    private class statusComboListener implements ActionListener {
        ...
        /**
         * Changes the status of the user on the server. It takes an ActionEvent
