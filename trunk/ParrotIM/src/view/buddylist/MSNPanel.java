 ...
 */
public class MSNPanel extends JPanel implements Observer {
    /*
    ...
    // SELECTION
    // II-Constructors
    public MSNPanel(MainController c, Model model, JFrame buddyWindow) {
        ...
        buddyListPane.addGroup("     MSN", twitterImage);
