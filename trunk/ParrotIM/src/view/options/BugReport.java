...
/**
 * The BugReport is currently responsible for delivering an email to the
 * Parrot IM bug report team.
 * 
 */
...
public class BugReport 
{
    ...
    /**
     * BugReport(String userEmail, String password) connects you to the Java mail service to
     * effortlessly send an email to another user. 
     * 
     * 
     * @param userEmail
	...
	public synchronized void sendReport(String title, String bodyMessage, String recipient) throws AddressException, MessagingException 
	{	
		...
		SessionPasswordAuthenticator sessionPasswordAuthenticator = new SessionPasswordAuthenticator();	
		Session authenticateSession = Session.getDefaultInstance(property, sessionPasswordAuthenticator);
