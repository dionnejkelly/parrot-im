...
public class BugReportFrame extends JFrame {
    ...
    public BugReportFrame(Model model) {
        ...
        this.addWindowListener(new PopupEnableMainWindowListener(model,
                PopupEnableWindowType.BUGREPORT));
    ...
    private void setPanels() {
        ...
        questionLabel = new JLabel("To: " + messageTo, SwingConstants.LEFT);
        ...
        subjectLabel = new JLabel("Title: ", SwingConstants.LEFT);
        ...
        messageText
                .setToolTipText("Enter a detailed description of the problem. Please be specific.");

        JScrollPane QListScroll = new JScrollPane(messageText);
        QListScroll.setPreferredSize(new Dimension(362, 180));

        sendButton =
                new JButton("Send", new ImageIcon(this.getClass().getResource(
                        "/images/buddylist/email_go.png")));
    ...
    private class sendActionListener implements ActionListener {
        public void actionPerformed(ActionEvent e) {
            ...
            BugReport sendAemail =
                    new BugReport("cmpt275testing@gmail.com", "abcdefghi");
            try {
                sendAemail.sendReport(subjectText.getText(), "Frequency: "
                        + frequencyReport + "\n" + "Severity: "
                        + severityReport + "\n" + "Message:\n"
