...
public class HelpPanel extends JPanel {
    public static final String GOOGLE_URL =
            "http://www.google.com/custom?client=pub-3922476703716903&forid=1&ie=ISO-8859-1&oe=ISO-8859-1&cof=GALT%3A%23008000%3BGL%3A1%3BDIV%3A%23336699%3BVLC%3A663399%3BAH%3Acenter%3BBGC%3AFFFFFF%3BLBGC%3A336699%3BALC%3A0000FF%3BLC%3A0000FF%3BT%3A000000%3BGFNT%3A0000FF%3BGIMP%3A0000FF%3BFORID%3A1%3B&hl=en&q=";
    ...
    public HelpPanel(String url) {
        ...
        //		
        // frame.setIconImage(new ImageIcon(getcwd() +
        ...
        // ActivatedHyperlinkListener(editorPane);
    ...
    public void googlePanel(String word) throws UnsupportedEncodingException {
        ...
        if (osName.contains("win")) {
            browserPath = "C:/Program Files/Internet Explorer/IEXPLORE.EXE "; // Use
                                                                              // your
                                                                              // browser
                                                                              // path
