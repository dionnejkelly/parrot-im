...
public class ThemeOptionsFrame extends JFrame {
    ...
    public ThemeOptionsFrame() {
        ...
        ImageIcon themeOriginal =
                new ImageIcon(this.getClass().getResource(
                        "/images/chatwindow/pic.png"));
        ImageIcon themeMetal =
                new ImageIcon(this.getClass().getResource(
                        "/images/chatwindow/pic.png"));
        ImageIcon themeWindows =
                new ImageIcon(this.getClass().getResource(
                        "/images/chatwindow/pic.png"));
        ImageIcon themeWindowsClassic =
                new ImageIcon(this.getClass().getResource(
                        "/images/chatwindow/pic.png"));

        JLabel metalicMenuItem =
                new JLabel("Metalic", themeOriginal, SwingConstants.LEFT);
        metalicMenuItem.addMouseListener(new MenuMouseListener());
        JLabel motifMenuItem =
                new JLabel("CDE/Motif", themeMetal, SwingConstants.LEFT);
        motifMenuItem.addMouseListener(new MenuMouseListener());
        JLabel windowsMenuItem =
                new JLabel("Windows", themeWindows, SwingConstants.LEFT);
        windowsMenuItem.addMouseListener(new MenuMouseListener());
        JLabel windowsClassicMenuItem =
                new JLabel("Windows Classic", themeWindowsClassic,
                        SwingConstants.LEFT);
        windowsClassicMenuItem.addMouseListener(new MenuMouseListener());

        JPanel themeMenuPanel = new JPanel();
        themeMenuPanel
                .setLayout(new BoxLayout(themeMenuPanel, BoxLayout.Y_AXIS));
