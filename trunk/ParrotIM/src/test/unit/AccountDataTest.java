...
public class AccountDataTest {
    ...
    public void setUp() throws Exception {
        // Look at equals
        // GoogleTalkManager e = new GoogleTalkManager(new MainController(new
        // Model()));
        ad1 = new GoogleTalkAccountData("Rakan", "1234");
        ad2 = new GoogleTalkAccountData("Ross", "abc");
        ad3 =
                new JabberAccountData("Janice", "ohmygod", "With friends",
                        "ght", UserStateType.AWAY, new JabberManager(
                                new MainController(new Model()), new Model()));
        ad4 = new JabberAccountData("Joey", "Friends");
        ad5 =
                new GoogleTalkAccountData("Peter", "familyguy", "Eating",
                        "sss", UserStateType.ONLINE, new GoogleTalkManager(
                                new MainController(new Model()), new Model()));
    }
    ...
    @Test
    public void testAccountDataStringString() throws ClassNotFoundException,
            SQLException {
    ...
    public void testAccountDataStringStringStringString() {
        ad6 =
                new JabberAccountData("Zeina", "ZH", "Playing COD", "r43",
                        UserStateType.BUSY, new JabberManager(
                                new MainController(new Model()), new Model()));
    ...
    /*
     * public void testSetServer() { AccountData expected = new
     * GoogleTalkAccountData("Rakan", "Rick",);
     * ad1.setServer(ServerType.JABBER); assertSame(expected.getServer(),
     * ad1.getServer()); }
     */
    //
    @Test
    ...
    public void testAddFriend() {
        ...
        UserData e =
                new GoogleTalkUserData("toot", "talal",
                        "Have an exam tommorow", UserStateType.OFFLINE, false);
        expected.add(e);
        assertTrue(ad1.addFriend(new GoogleTalkUserData("toot", "talal",
                "Have an exam tommorow", UserStateType.OFFLINE, false)));
    ...
    public void testRemoveFriend() {
        GoogleTalkUserData e1 =
                new GoogleTalkUserData("Horton", "tim", "In a coffe shop",
                        UserStateType.AWAY, true);
        GoogleTalkUserData e2 =
                new GoogleTalkUserData("Star", "Bucks", "Studying",
                        UserStateType.BUSY, false);
        ad2.addFriend(e1);
        ad2.addFriend(e2);
        assertTrue(ad2.removeFriend(e2));
        // Review this
        assertTrue(ad2.removeFriend(new GoogleTalkUserData("Horton", "tim",
                "In a coffe shop", UserStateType.AWAY, true)));
    ...
    public void testGetFriends() {
        GoogleTalkUserData e1 =
                new GoogleTalkUserData("Horton", "tim", "Playing ps3",
                        UserStateType.ONLINE, true);
        GoogleTalkUserData e2 =
                new GoogleTalkUserData("Star", "Bucks", "Cocking",
                        UserStateType.BUSY, false);
        ad4.addFriend(e1);
        ad4.addFriend(e2);
        ...
        assertSame(((GoogleTalkUserData) array1[0]).getUserID(), e1.getUserID());
        assertSame(((GoogleTalkUserData) array1[1]).getUserID(), e2.getUserID());
    }
    ...
    /*
     * public void testSetConnected() { boolean expected = true;
     * ad1.setConnected(true); assertSame(expected, ad1.isConnected());
     * ad1.setConnected(false); assertNotSame(expected, ad1.isConnected()); }
     * 
     * @Test public void testIsConnected() { boolean expected = false;
     * assertSame(expected, ad2.isConnected()); ad2.setConnected(true);
