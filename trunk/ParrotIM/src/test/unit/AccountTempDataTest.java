...
public class AccountTempDataTest {
	...
	public void testSetServer() {
		AccountTempData expected = new AccountTempData(ServerType.JABBER,"Rakan","1234");
	...
	public void testSetUserID() {
		...
		AccountTempData expected = new AccountTempData(ServerType.ICQ,"Chandler","abc");
	...
	public void testSetPassword() {
		...
		AccountTempData expected = new AccountTempData(ServerType.MSN,"Janice","qwerty");
