...
/**
 * The Chatbot currently stores all the knowledge base and respond list data to
 * provide users with auto-mated messaging. The Chatbot can be turn on/off from
 * the Contact List by simply clicking the Chatbot Enabled.
 * 
 */
...
public class Chatbot {
    ...
    private String transposList[][] =
            { { "I'M", "YOU'RE" }, { "AM", "ARE" }, { "WERE", "WAS" },
                    { "ME", "YOU" }, { "YOURS", "MINE" }, { "YOUR", "MY" },
                    { "I'VE", "YOU'VE" }, { "I", "YOU" },
                    { "AREN'T", "AM NOT" }, { "WEREN'T", "WASN'T" },
                    { "I'D", "YOU'D" }, { "DAD", "FATHER" },
                    { "MOM", "MOTHER" }, { "DREAMS", "DREAM" },
                    { "MYSELF", "YOURSELF" } };
            ...
            {
                    {
                            ...
                            { "MY NAME IS Parrot Bot.",
                                    "YOU CAN CALL ME Parrot Bot.",
                    ...
                    { { "NO PROBLEM" },
                            { "SO, YOU APPROVE IT.", "SO, IT'S ALL OK." } },
    ...
    /**
     * Handles user's question repetition to check whether or not they are
     * repeating.
     * 
     */
...
//        }
    ...
    public boolean bot_repeat() {
        return (sPrevResponse.length() > 0 && sResponse.equals(sPrevResponse));
    }
    ...
    public boolean user_repeat() {
        return (sPrevInput.length() > 0 && ((sInput.equals(sPrevInput))
                || (sInput.indexOf(sPrevInput) != -1) || (sPrevInput
                .indexOf(sInput) != -1)));
    }

    /**
     * Checks whether the Chatbot understand ands reacts appropriately.
     * 
     * @return boolean
     */
    ...
    public boolean null_input() {
        // I changed this into 2 instead of 0, because any preprocess input will
        // have two spaces
    ...
    /**
     * Check whether user's current input contains unnecessary symbols and
     * punctuation.
     * 
     * @param ch
     * @return boolean
    ...
    public void find_subject() {
        ...
        if (pos != -1) {
            sSubject =
                    sInput.substring(pos + sKeyWord.length() - 1, sInput
                            .length());
        }
    }
