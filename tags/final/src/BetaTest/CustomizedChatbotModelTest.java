...
public class CustomizedChatbotModelTest {
    ...
    public void setUp() throws Exception {
        ...
        ChatbotQADataType cd1 =
                new ChatbotQADataType(new Model(), "Hey, got a minute?",
                        "What's up?");
        cm1.addQA(cd1);
        // Why this doesn't work?
        /*
         * System.out.println(cm1.getQASize()); for(int
         * i=0;i<cm1.getQASize();i++){
    ...
    @Test
    public void testCustomizedChatbotModel() throws ClassNotFoundException,
            SQLException {
    ...
    public void testAddQA() throws SQLException, ClassNotFoundException {
        ...
        int x = cm1.getQASize();
        ChatbotQADataType cd2 =
                new ChatbotQADataType(new Model(),
                        "Hey, are you watching a movie?", "No");
        cm1.addQA(cd2);
        int expected = x + 1;
