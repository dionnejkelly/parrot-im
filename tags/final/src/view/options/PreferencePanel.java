...
public class PreferencePanel extends GPanel implements Observer {
    ...
    public PreferencePanel(MainController c, JFrame mainframe, final Model model)
        ...
        chatPaneColorPanel.setBorder(BorderFactory
        ...
        String[] presetStrings =
                { "-- Select a Color Scheme --", "Default", "Steel", "Ice",
                        "Fire", "Jungle", "Custom" };
        ...
        presets.addActionListener(new ActionListener() {
            public void actionPerformed(ActionEvent arg0) {
                if (presets.getSelectedItem().toString().equals("Default")) {
                    ...
                    model.primaryTextColor = Color.WHITE;
                    model.textPaneColor = Color.WHITE;
                } else if (presets.getSelectedItem().toString()
                        .equals("Jungle")) {
    ...
    private void openColorChooser(String title, JButton buttonPressed,
            Model model) {
        colorChooser.setTitle(title);
        colorChooser.setDefaultCloseOperation(WindowConstants.HIDE_ON_CLOSE);
        colorChooser.setContentPane(new ThemeColorChooser(colorChooser,
                buttonPressed, model));
        colorChooser.pack();
